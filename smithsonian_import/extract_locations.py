...
marsh = Dataset("", "chesapeake_marsh.csv", mapped_columns=mapped_columns)
marsh_locations = marsh.get_locations()

plot = Dataset("", "chesapeake_plot.csv", mapped_columns=plot_mapped_columns, location_keyfile='location_plot.json')
